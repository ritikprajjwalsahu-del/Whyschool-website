  ...
  return (
    <motion.div
      style={{
        ...
        scale,
        boxShadow:
          '0 25px 50px -12px rgba(11, 13, 17, 0.4), 0 0 0 1px rgba(255, 101, 0, 0.25)',
      }}
      className="max-w-6xl mx-auto h-[34rem] md:h-[42rem] w-full border-2 border-[#FF6500]/30 p-2 md:p-4 bg-[#131A2B] rounded-[32px] shadow-2xl relative overflow-hidden backdrop-blur-xl"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-[#0B0D11]/95 p-4 md:p-6 flex flex-col justify-between border border-white/10 text-white">
        {children}
      </div>
    </motion.div>
  );
